package business;
import system.iterator.myLinkedList;
import tools.scanner.ScannerHandler;
import system.iterator.myIterator;
import system.Request;
import system.Handler;
import tools.*;
import tools.maker.CoffeeMaker;
import tools.maker.CoffeeMakerHandler;
import tools.maker.IceCreamMaker;
import tools.maker.IceCreamMakerHandler;
import tools.maker.MilkTeaMaker;
import tools.maker.MilkTeaMakerHandler;
import tools.scanner.RealScanner;

/**
 * @author Zhou Hongyu
 */
public class ToolsChain {
     ...
     */
    public ToolsChain(int numofScanner, int numofMicro, int numofMilkTeaMaker, int numofIceMaker, int numofCoffeeMaker){
